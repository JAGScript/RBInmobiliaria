<?php
	...
	$sql1 = "SELECT * FROM barrio JOIN parroquia ON ba_parroquia_id = pq_id";
	...
	$sql2 = "SELECT * FROM barrio JOIN parroquia ON ba_parroquia_id = pq_id LIMIT " . (($paginacion->get_page() - 1) * $resultados) . ', ' . $resultados;
			...
			<div class="table-responsive">
				<table class="table table-striped">
					...
					<tr style="text-align:center;">
						...
						<td>
							<button class="btn btn-primary" type="button" onclick="editar('.$row2['ba_id'].')">Editar</button>
						</td>
					</tr>
					';
					}
...
function nuevo(){
	window.location = '?modulo=nuevobarrio';
}

function editar(data){
	window.location = '?modulo=editarbarrio&data='+data;
}
</script>