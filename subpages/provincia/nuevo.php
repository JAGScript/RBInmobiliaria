...
<div class="row" style="margin:25px 0px 75px 0px;">
	<div class="col-md-8 col-md-push-2" style="border:2px solid #ccc; border-radius:10px; padding:20px;">
		<div class="row">
			...
			<div class="col-md-9">
				<input type="text" id="codigo" class="form-control" placeholder="Código de Provincia" />
			</div>
		</div>
		<div class="row">
			<div class="col-md-3">
			...
			<div class="col-md-9">
				<input type="text" id="nombre" class="form-control" placeholder="Nombre Provincia" />
			</div>
		</div>
...
function guardar(){
	...
	if(nombre == '' || codigo == ''){
		...
		$.post('subpages/provincia/ajax/guardarnuevo.php',{
