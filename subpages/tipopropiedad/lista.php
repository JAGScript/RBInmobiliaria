<?php
	...
	$sql1 = "SELECT * FROM tipo_propiedad";
	...
	$sql2 = "SELECT * FROM tipo_propiedad LIMIT " . (($paginacion->get_page() - 1) * $resultados) . ', ' . $resultados;
			...
			<div class="table-responsive">
				<table class="table table-striped">
					...
					<tr style="text-align:center;">
						...
						<td>
							<button class="btn btn-primary" type="button" onclick="editar('.$row2['tp_id'].')">Editar</button>
						</td>
					</tr>
					';
					}
...
function nuevo(){
	window.location = '?modulo=nuevotipopropiedad';
}

function editar(data){
	window.location = '?modulo=editartipopropiedad&data='+data;
}
</script>